            ...
            <div className="search">
                <div className="search-div">
                    ...
                    <select id="lists">
                        ...
                        <option value="demanage">Travaux d'intérieur</option>
                        <option value="informatiqe">Informatique</option>
                        <option value="accompagne">Transport</option>
                        <option value="accompagne">Divers</option>
                    </select>
                </div >
            </div >
            <div className="div-option">
                <h3>27 offres pour le menage</h3>
            </div>
